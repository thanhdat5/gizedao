...
const GZLoginPage = () => {
    ...
    return <>
        <Stack direction={['column', 'column', 'row']} spacing={0} bg='#0E1420'>
            ...
            >
                ...
                <Box textAlign="center" w="360px" maxW="100%" mx="auto">
                    ...
                    <Box mb="16px">
                        <Button w="100%" size="lg" onClick={onOpen}>Continue with email</Button>
                    </Box>
                    <Box mb="16px">
                ...
                <Box mt="auto" position="absolute" top="calc(max(100vh, 700px) - 40px)" right="27px">
                    <Link
                        ...
                        alignItems="center"
                        href="mailto:Support@espstarter.com"
                        _hover={{ color: "#fff" }}
                    >
                        <GZIconMail20px />
                        <Text as="span" ms="10px" fontSize="14px" lineHeight="140%">Support@espstarter.com</Text>
                    </Link>
                </Box>
            </Flex>
            <Box
                ...
                <Box
                    ...
                    mb="40px"
                >
                    <Text fontWeight="500" fontFamily="Chakra Petch" as="span" color="#0075C4">GizeDAO</Text> is an all-in-one platform for starting, managing, and growing your decentralized autonomous organization (DAO). Our platform provides a comprehensive suite of tools to help you launch and manage your own DAO, including features such as creating and selling NFTs, managing treasury, setting governance, and more. Our mission is to empower individuals and organizations to take control of their communities and assets through decentralized technology.
                </Box>
                <Box flex={1}><Image src="/images/logo.svg" alt="" mx="auto" /></Box>
            </Box>
        </Stack>
        {/* <GZMessageDialog
            isOpen={isOpen}
        ...
        <GZMessageDialog
            ...
            body="Check your spams if you didn't received anything"
            closeText="Confirm"
            onClose={onClose}
        />
    </>
