...
type GZUserFullProfileProps = {
    isEdit?: boolean;
    setisEdit?: any;
    initialValues?: any;
    onSave?: any;
};
const GZUserProfileEdit = ({
    isEdit,
    setisEdit,
    initialValues,
    onSave,
}: GZUserFullProfileProps) => {
    return (
        <Grid
            h="200px"
            ...
            <GridItem rowSpan={2} colSpan={2} >
                <Flex>
                    ...
                    <Box w='204px'>
                        ...
                        <NavLink style={({ isActive }) => ({ backgroundColor: isActive ? "#242E42" : "", display: 'block', borderRadius: '5px' })} className={(isActive) => (isActive ? 'active' : '')} to='/edit-profile'
                        >
                            <Flex padding='8px'>
                                <GIZProfile2 />
                        ...
                        <NavLink style={({ isActive }) => ({ backgroundColor: isActive ? "#242E42" : "", display: 'block', borderRadius: '5px' })} className={(isActive) => (isActive ? 'active' : '')} to='/notification'>
                            <Flex padding='8px'>
                                <GZIconBellActive />
                        ...
                        <NavLink style={({ isActive }) => ({ backgroundColor: isActive ? "#242E42" : "", display: 'block', borderRadius: '5px' })} className={(isActive) => (isActive ? 'active' : '')} to=''>
                            <Flex padding='8px'>
                                <GZIconIntegrations />
...
export default GZUserProfileEdit;
